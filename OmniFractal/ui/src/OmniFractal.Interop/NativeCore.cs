...
//
// NativeCore.cs -- the managed side of the OmniFractalCore boundary.
//
...
namespace OmniFractal.Interop;

/// <summary>Thrown for any non-zero result code from OmniFractalCore.</summary>
public sealed class OmniFractalException : Exception
{
    public OmfResult Result { get; }

    public OmniFractalException(OmfResult result, string message) : base(message) => Result = result;
}

internal static partial class NativeMethods
{
    private const string Library = "OmniFractalCore";

    // -- lifetime ------------------------------------------------------

    [LibraryImport(Library)]
    internal static partial int omf_abi_version();

    [LibraryImport(Library)]
    internal static partial nint omf_version_string();

    [LibraryImport(Library)]
    internal static partial nint omf_last_error();

    [LibraryImport(Library)]
    internal static partial int omf_context_create(int preferred, out nint outContext);

    [LibraryImport(Library)]
    internal static partial void omf_context_destroy(nint context);

    [LibraryImport(Library)]
    internal static partial int omf_context_set_log(nint context, nint callback, nint user);

    [LibraryImport(Library)]
    internal static partial int omf_context_backend(nint context);

    [LibraryImport(Library)]
    internal static partial nint omf_context_device_name(nint context);

    [LibraryImport(Library)]
    internal static partial void omf_render_settings_default(out RenderSettings settings);

    // -- rendering -----------------------------------------------------

    [LibraryImport(Library)]
    internal static partial int omf_render_begin(nint context, in RenderSettings settings,
                                                  out nint outJob);

    [LibraryImport(Library)]
    internal static partial int omf_job_set_callbacks(nint job, nint progress, nint cancel,
                                                       nint user);

    [LibraryImport(Library)]
    internal static partial int omf_job_wait(nint job, int timeoutMs);

    [LibraryImport(Library)]
    internal static partial int omf_job_cancel(nint job);

    [LibraryImport(Library)]
    internal static partial int omf_job_progress(nint job, out RenderProgress progress);

    [LibraryImport(Library)]
    internal static partial int omf_job_layer(nint job, uint layer, out ImageView view);

    [LibraryImport(Library)]
    internal static partial void omf_job_release(nint job);

    // -- post ----------------------------------------------------------

    [LibraryImport(Library)]
    internal static partial int omf_post_recompute_normals(nint job, float strength);

    [LibraryImport(Library)]
    internal static partial int omf_post_ssao(nint job, float radius, float intensity,
                                               int samples);

    [LibraryImport(Library)]
    internal static partial int omf_post_hard_shadows(nint job, float bias);

    [LibraryImport(Library)]
    internal static partial int omf_post_depth_of_field(nint job, float focalPlane,
                                                         float strength);

    [LibraryImport(Library)]
    internal static partial int omf_post_composite(nint job);
    ...
    internal static partial int omf_identify_file(string path);

    [LibraryImport(Library)]
    internal static partial int omf_scene_create(out nint outScene);

    [LibraryImport(Library)]
    internal static partial int omf_scene_settings(nint scene, out RenderSettings settings);

    [LibraryImport(Library)]
    internal static partial int omf_scene_set_settings(nint scene, in RenderSettings settings);

    [LibraryImport(Library)]
    internal static partial int omf_scene_legacy_settings(nint scene,
                                                           out RenderSettings settings);

    [LibraryImport(Library)]
    internal static partial int omf_scene_has_legacy_settings(nint scene);

    [LibraryImport(Library)]
    internal static partial int omf_scene_provenance(nint scene, out ProvenanceBlock provenance);

    [LibraryImport(Library)]
    internal static partial void omf_scene_destroy(nint scene);

    [LibraryImport(Library, StringMarshalling = StringMarshalling.Utf8)]
    internal static partial int omf_m4d_read(string path, out nint outScene);

    [LibraryImport(Library, StringMarshalling = StringMarshalling.Utf8)]
    internal static partial int omf_m4d_write(string path, nint scene);

    [LibraryImport(Library, StringMarshalling = StringMarshalling.Utf8)]
    internal static partial int omf_m4d_write_with_image(string path, nint scene, nint job);

    // -- legacy import (read only) --------------------------------------

    [LibraryImport(Library, StringMarshalling = StringMarshalling.Utf8)]
    internal static partial int omf_import_legacy(string path, string profileId,
                                                   out nint outScene,
                                                   out NativeImportReport report);

    [LibraryImport(Library, StringMarshalling = StringMarshalling.Utf8)]
    internal static unsafe partial int omf_m3i_extract_parameters(string path, byte* buffer,
                                                                   nuint bufferSize,
                                                                   out nuint needed);

    [LibraryImport(Library, StringMarshalling = StringMarshalling.Utf8)]
    internal static unsafe partial int omf_inspect_legacy_formula(string path, byte* outName,
                                                                   nuint nameCapacity,
                                                                   out int outClass,
                                                                   out int outResolved);
    ...
    [LibraryImport(Library)]
    internal static partial int omf_profile_count();

    [LibraryImport(Library)]
    internal static partial nint omf_profile_id_at(int index);

    [LibraryImport(Library, StringMarshalling = StringMarshalling.Utf8)]
    internal static partial int omf_precision_profile_by_id(string id,
                                                             out PrecisionProfile profile);

    [LibraryImport(Library, StringMarshalling = StringMarshalling.Utf8)]
    internal static partial int omf_migrate_parameters(in RenderSettings legacy,
                                                        int targetWidth, int targetHeight,
                                                        string targetProfileId,
                                                        out RenderSettings migrated);

    [LibraryImport(Library)]
    internal static partial int omf_rescale_for_resolution(ref RenderSettings settings,
                                                            int targetWidth, int targetHeight,
                                                            int lockToLegacyLook);

    [LibraryImport(Library, StringMarshalling = StringMarshalling.Utf8)]
    internal static partial int omf_write_exr(string path, nint job, int multilayer);

    [LibraryImport(Library)]
    internal static partial int omf_formula_count(nint context);

    [LibraryImport(Library)]
    internal static partial nint omf_formula_name_at(nint context, int index);

    [LibraryImport(Library)]
    internal static partial uint omf_context_precision_support(nint context);
    ...
    [LibraryImport(Library)]
    internal static partial int omf_mesh_extract(nint context, in RenderSettings settings,
                                                  in MeshSettings meshSettings, nint progress,
                                                  nint user, out nint outMesh);

    [LibraryImport(Library)]
    internal static partial int omf_mesh_stats(nint mesh, out MeshStats stats);

    [LibraryImport(Library, StringMarshalling = StringMarshalling.Utf8)]
    internal static partial int omf_mesh_write_stl(nint mesh, string path, int binary);

    [LibraryImport(Library, StringMarshalling = StringMarshalling.Utf8)]
    internal static partial int omf_mesh_write_step(nint mesh, string path);

    [LibraryImport(Library, StringMarshalling = StringMarshalling.Utf8)]
    internal static partial int omf_mesh_write_obj(nint mesh, string path);

    [LibraryImport(Library)]
    internal static partial void omf_mesh_destroy(nint mesh);

    // -- lua -----------------------------------------------------------

    [LibraryImport(Library)]
    internal static partial int omf_lua_create(nint context, out nint outLua);

    [LibraryImport(Library, StringMarshalling = StringMarshalling.Utf8)]
    internal static partial int omf_lua_run_file(nint lua, string path);

    [LibraryImport(Library, StringMarshalling = StringMarshalling.Utf8)]
    internal static partial int omf_lua_run_string(nint lua, string source);

    [LibraryImport(Library)]
    internal static unsafe partial int omf_lua_bind_settings(nint lua, RenderSettings* settings);

    [LibraryImport(Library, StringMarshalling = StringMarshalling.Utf8)]
    internal static partial int omf_lua_call_frame(nint lua, string fnName, int frame,
                                                    double time);

    [LibraryImport(Library)]
    internal static unsafe partial int omf_lua_push_fft(nint lua, float* bins, int count);

    [LibraryImport(Library)]
    internal static partial void omf_lua_destroy(nint lua);

    // -- animation -----------------------------------------------------

    [LibraryImport(Library)]
    internal static partial int omf_animation_keyframe_count(nint scene);

    [LibraryImport(Library)]
    internal static partial int omf_animation_keyframe_at(nint scene, int index,
                                                           out Keyframe keyframe);

    [LibraryImport(Library)]
    internal static partial int omf_animation_evaluate(nint scene, int frame,
                                                        ref RenderSettings settings);

    // -- utility -------------------------------------------------------

    [LibraryImport(Library)]
    internal static unsafe partial int omf_sample_de(nint context, in RenderSettings settings,
                                                      double* point, out double outDe);

    [LibraryImport(Library)]
    internal static unsafe partial int omf_trace_ray(nint context, in RenderSettings settings,
                                                      double* origin, double* direction,
                                                      out double distance, double* normal);

    [LibraryImport(Library)]
    internal static unsafe partial int omf_mutate(in RenderSettings baseSettings,
...
public sealed class RenderJob : IDisposable
{
    ...
    {
        int result = NativeMethods.omf_job_wait(Handle, timeoutMs);
        if (result == (int)OmfResult.NotReady) return false;
        NativeCore.Check(result);
        return true;
    }

    public void Cancel() => NativeCore.Check(NativeMethods.omf_job_cancel(Handle));

    public RenderProgress GetProgress()
    {
        NativeCore.Check(NativeMethods.omf_job_progress(Handle, out RenderProgress progress));
        return progress;
    }
    ...
    {
        NativeCore.Check(NativeMethods.omf_job_layer(Handle, (uint)layer, out ImageView view));
        return view;
    }

    public void RecomputeNormals(float strength = 1.0f) =>
        NativeCore.Check(NativeMethods.omf_post_recompute_normals(Handle, strength));

    public void ApplySsao(float radius, float intensity, int samples) =>
        NativeCore.Check(NativeMethods.omf_post_ssao(Handle, radius, intensity, samples));

    public void ApplyHardShadows(float bias = 1e-4f) =>
        NativeCore.Check(NativeMethods.omf_post_hard_shadows(Handle, bias));

    public void ApplyDepthOfField(float focalPlane, float strength) =>
        NativeCore.Check(NativeMethods.omf_post_depth_of_field(Handle, focalPlane, strength));

    /// <summary>Runs every post pass the scene settings enable, in order.</summary>
    public void Composite() => NativeCore.Check(NativeMethods.omf_post_composite(Handle));

    public void SaveExr(string path, bool multilayer = true) =>
        NativeCore.Check(NativeMethods.omf_write_exr(path, Handle, multilayer ? 1 : 0));
    ...
    public void Dispose()
    {
        ...
        NativeMethods.omf_job_release(_handle);
        _handle = nint.Zero;
...
public sealed class MeshHandle : IDisposable
{
    ...
    {
        NativeCore.Check(NativeMethods.omf_mesh_stats(Handle, out MeshStats stats));
        return stats;
    }

    public void SaveStl(string path, bool binary = true) =>
        NativeCore.Check(NativeMethods.omf_mesh_write_stl(path is null
            ? throw new ArgumentNullException(nameof(path)) : Handle, path, binary ? 1 : 0));

    public void SaveStep(string path) =>
        NativeCore.Check(NativeMethods.omf_mesh_write_step(Handle, path));

    public void SaveObj(string path) =>
        NativeCore.Check(NativeMethods.omf_mesh_write_obj(Handle, path));

    public void Dispose()
    {
        if (_handle == nint.Zero) return;
        NativeMethods.omf_mesh_destroy(_handle);
        _handle = nint.Zero;
        GC.SuppressFinalize(this);
    }
...
public sealed class LuaScript : IDisposable
{
    ...
    public void RunFile(string path) =>
        NativeCore.Check(NativeMethods.omf_lua_run_file(Handle, path));

    public void Run(string source) =>
        NativeCore.Check(NativeMethods.omf_lua_run_string(Handle, source));
    ...
    public unsafe void BindSettings(RenderSettings* settings) =>
        NativeCore.Check(NativeMethods.omf_lua_bind_settings(Handle, settings));

    public void CallFrame(string functionName, int frame, double time) =>
        NativeCore.Check(NativeMethods.omf_lua_call_frame(Handle, functionName, frame, time));
    ...
    public unsafe void PushFft(ReadOnlySpan<float> bins)
    {
        fixed (float* p = bins)
        {
            NativeCore.Check(NativeMethods.omf_lua_push_fft(Handle, p, bins.Length));
        }
    }
    ...
    {
        if (_handle == nint.Zero) return;
        NativeMethods.omf_lua_destroy(_handle);
        _handle = nint.Zero;
        GC.SuppressFinalize(this);
    }
...
public sealed class Scene : IDisposable
{
    ...
    public bool HasLegacySettings =>
        NativeMethods.omf_scene_has_legacy_settings(Handle) != 0;

    public RenderSettings GetLegacySettings()
    {
        Check(NativeMethods.omf_scene_legacy_settings(Handle, out RenderSettings settings));
        return settings;
    }

    public ProvenanceBlock GetProvenance()
    {
        Check(NativeMethods.omf_scene_provenance(Handle, out ProvenanceBlock provenance));
        return provenance;
    }
    ...
    {
        NativeCore.Check(NativeMethods.omf_scene_settings(Handle, out RenderSettings settings));
        return settings;
    }

    public void SetSettings(in RenderSettings settings) =>
        NativeCore.Check(NativeMethods.omf_scene_set_settings(Handle, settings));

    public int KeyframeCount => NativeMethods.omf_animation_keyframe_count(Handle);

    public Keyframe GetKeyframe(int index)
    {
        NativeCore.Check(NativeMethods.omf_animation_keyframe_at(Handle, index,
                                                                  out Keyframe keyframe));
        return keyframe;
    }
    ...
    public void EvaluateAt(int frame, ref RenderSettings settings) =>
        NativeCore.Check(NativeMethods.omf_animation_evaluate(Handle, frame, ref settings));

    public void Dispose()
    {
        if (_handle == nint.Zero) return;
        NativeMethods.omf_scene_destroy(_handle);
        _handle = nint.Zero;
        GC.SuppressFinalize(this);
    }
...
public sealed partial class NativeCore : IDisposable
{
    ...
    public static string VersionString => PtrToString(NativeMethods.omf_version_string());

    public static int AbiVersion => NativeMethods.omf_abi_version();

    public OmfBackend Backend => (OmfBackend)NativeMethods.omf_context_backend(Handle);

    public string DeviceName => PtrToString(NativeMethods.omf_context_device_name(Handle));
    ...
    /// different revisions.
    /// </summary>
    public static NativeCore Create(OmfBackend preferred = OmfBackend.Auto)
    {
        AbiLayout.Verify();

        int nativeAbi = NativeMethods.omf_abi_version();
        if (nativeAbi != Abi.Version)
        {
            throw new OmniFractalException(OmfResult.AbiMismatch,
                $"OmniFractalCore reports ABI {nativeAbi}, this build expects {Abi.Version}. " +
                "The native library and the UI are from different revisions.");
        }

        Check(NativeMethods.omf_context_create((int)preferred, out nint context));
    ...
    {
        NativeMethods.omf_render_settings_default(out RenderSettings settings);
        return settings;
    }
    ...
    {
        Check(NativeMethods.omf_render_begin(Handle, settings, out nint job));
    ...
    public static OmfFileKind Identify(string path) =>
        (OmfFileKind)NativeMethods.omf_identify_file(path);

    /// <summary>Reads a native .m4d scene.</summary>
    public static Scene LoadScene(string path)
    {
        Check(NativeMethods.omf_m4d_read(path, out nint scene));
    ...
    public static void SaveScene(string path, Scene scene)
    {
        ...
        Check(NativeMethods.omf_m4d_write(path, scene.Handle));
    }
    ...
    public static void SaveSceneWithImage(string path, Scene scene, RenderJob job)
    {
        ...
        Check(NativeMethods.omf_m4d_write_with_image(path, scene.Handle, job.Handle));
    }
                                     ...
                                     out NativeImportReport report)
    {
        ...
        Check(NativeMethods.omf_import_legacy(path, profileId, out nint scene, out report));
        return new Scene(scene);
    }
    ...
    {
        Check(NativeMethods.omf_m3i_extract_parameters(path, null, 0, out nuint needed));
        if (needed == 0) return [];

        byte[] buffer = new byte[needed];
        fixed (byte* p = buffer)
        {
            Check(NativeMethods.omf_m3i_extract_parameters(path, p, needed, out _));
        }
        return buffer;
    }
    ...
    public static unsafe (string Name, int Class, bool Resolved) InspectLegacyFormula(string path)
    {
        ...
        Check(NativeMethods.omf_inspect_legacy_formula(path, name, capacity,
    ...
    {
        int count = NativeMethods.omf_profile_count();
        var ids = new List<string>(count);
        for (int i = 0; i < count; i++)
        {
            ids.Add(PtrToString(NativeMethods.omf_profile_id_at(i)));
        }
        return ids;
    }
    ...
    {
        Check(NativeMethods.omf_precision_profile_by_id(id, out PrecisionProfile profile));
        return profile;
    }
                                                   ...
                                                   string targetProfileId)
    {
        ...
        Check(NativeMethods.omf_migrate_parameters(legacy, targetWidth, targetHeight,
                                                    targetProfileId,
                                                    out RenderSettings migrated));
        return migrated;
    }
    ...
    {
        Check(NativeMethods.omf_rescale_for_resolution(ref settings, targetWidth,
                                                        targetHeight,
                                                        lockToLegacyLook ? 1 : 0));
    }

    public uint PrecisionSupport => NativeMethods.omf_context_precision_support(Handle);
    ...
    {
        Check(NativeMethods.omf_mesh_extract(Handle, settings, meshSettings,
    ...
    {
        Check(NativeMethods.omf_lua_create(Handle, out nint lua));
                                                ...
                                                double x, double y, double z)
    {
        ...
        Check(NativeMethods.omf_sample_de(Handle, settings, point, out double de));
        return de;
    }
        ...
        double dx, double dy, double dz)
    {
        ...
        int result = NativeMethods.omf_trace_ray(Handle, settings, origin, direction,
                                                  out double distance, normal);
        if (result == (int)OmfResult.NotReady) return null;
        Check(result);
                                                 ...
                                                 int seed, float strength)
    {
        ...
        {
            Check(NativeMethods.omf_mutate(baseSettings, p, count, seed, strength));
        }
        return variants;
    }
    ...
    public void Dispose()
    {
        ...
        NativeMethods.omf_context_destroy(_context);
        _context = nint.Zero;
        GC.SuppressFinalize(this);
    }
    ...
    {
        if (result == (int)OmfResult.Ok) return;

        string message = PtrToString(NativeMethods.omf_last_error());
        if (string.IsNullOrEmpty(message)) message = $"OmniFractalCore error {result}";
        throw new OmniFractalException((OmfResult)result, message);
    }
    ...
    private sealed unsafe class ProgressThunk
    {
        ...
        public void Attach(nint job)
        {
            ...
            NativeMethods.omf_job_set_callbacks(job, (nint)_fn, nint.Zero,
