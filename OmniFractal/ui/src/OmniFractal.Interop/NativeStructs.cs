...
public enum OmfBackend { Auto = 0, Vulkan = 1, Cpu = 2 }
...
/// <summary>Blittable mirror of omf_import_report_t.</summary>
[StructLayout(LayoutKind.Sequential, Pack = 8)]
    ...
    public static void Verify()
    {
        ...
        if (problems is not null)
        {
            throw new InvalidOperationException(
                "OmniFractalCore ABI layout mismatch — the native library and this assembly were " +
